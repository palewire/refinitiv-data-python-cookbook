...
Before you can connect with the [LSEG Data Library for Python](https://pypi.org/project/lseg-data/), you need to create an application key,  a unique identifier that allows you to connect to the platform and retrieve data.

Here's how to do it.

Visit the LSEG [web access portal](https://workspace.refinitiv.com/web/layout?layoutTemplate=marketMonitoring) from [workspace.refinitiv.com](https://workspace.refinitiv.com/). Sign in with your credentials.
...
A new row will appear in the table at the bottom of the screen. The “API Key“ column contains the token you will use to connect to the LSEG Data Library for Python. Save it to a secure location. The actual value of the key in the image below has been redacted.
